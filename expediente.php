...
<div class="modal fade" id="editarExpedienteModal" tabindex="-1" aria-labelledby="editarExpedienteModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-dark text-info">
        <h1 class="modal-title fs-5" id="editarExpedienteModalLabel"><i class="bi bi-journal-plus"></i> Editar procedimiento</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-clipboard2-pulse-fill"></i></span>
          <!-- <input type="text" class="form-control" placeholder="Procedimiento" aria-label="Procedimiento" aria-describedby="basic-addon1" id="procedimientoExpedienteEditar"> -->
          <textarea class="form-control" rows="4"
          placeholder="Descripción del procedimiento..." id="procedimientoExpedienteEditar"></textarea>

        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="bi bi-x-circle-fill"></i> Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="editarExpediente()"><i class="bi bi-floppy2-fill"></i> Guardar cambios</button>
      </div>
    </div>
  </div>
</div>
