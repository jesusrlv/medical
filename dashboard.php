    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="calendar.php" class="nav-link px-2 text-white"><i class="bi bi-list-columns-reverse"></i> Agenda</a></li>
    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-6">
        ...
        <div class="h-100 p-5 bg-info rounded-3 text-light">
          <h2><i class="bi bi-card-heading"></i>  Catálogo de diagnóstico</h2>
          <p>Visualizar el catálogo de diagnóstico con costos.</p>
          <a href="catalogo.php" class="btn btn-outline-light" type="button"><i class="bi bi-123"></i> Catálogo de procedimientos</a>
...
<div class="modal fade" id="exampleModalPaciente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="agregarPaciente" method="POST">
      ...
      <span class="h4"><i class="bi bi-exclamation-circle-fill"></i> Datos del paciente</span>
        ...
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label"><i class="bi bi-person-bounding-box"></i> Apellido</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Agregar apellido" name="apellido_paciente" required>
        </div>
