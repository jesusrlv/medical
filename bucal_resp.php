          ...
          <!-- <select class="form-select form-select-lg mb-3 w-100" aria-label=".form-select-lg example">
            ...
            <div class="list-group">
              ...
              <ul class="list-group">
                ...
                <span class="align-items-center"><i class="fas fa-tooth"></i> Diente 1</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/2.png" id="" class="me-3" width="14" alt=""> Diente 2</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/3.png" id="" class="me-3" width="14" alt=""> Diente 3</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/4.png" id="" class="me-3" width="14" alt=""> Diente 4</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/9.png" id="" class="me-3" width="14" alt=""> Diente 5</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/6.png" id="" class="me-3" width="14" alt=""> Diente 6</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/7.png" id="" class="me-3" width="14" alt=""> Diente 7</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/6.png" id="" class="me-3" width="14" alt=""> Diente 6</span>
                ...
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/8.png" id="" class="me-3" width="14" alt=""> Diente 8</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/9.png" id="" class="me-3" width="14" alt=""> Diente 9</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/10.png" id="" class="me-3" width="14" alt=""> Diente 10</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/11.png" id="" class="me-3" width="14" alt=""> Diente 11</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/12.png" id="" class="me-3" width="14" alt=""> Diente 12</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/13.png" id="" class="me-3" width="14" alt=""> Diente 13</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/14.png" id="" class="me-3" width="14" alt=""> Diente 14</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/15.png" id="" class="me-3" width="14" alt=""> Diente 15</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                <span class="align-items-center"><img src="assets/4x/16.png" id="" class="me-3" width="14" alt=""> Diente 16</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
              </ul>
            ...
            <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
            <span class="align-items-center"><i class="fas fa-grin-tongue h4"></i> Lengua</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
                <li class="list-group-item d-flex list-group-item-action justify-content-between align-items-center">
                  <span class="align-items-center"><img src="assets/4x/2.png" id="" class="me-3" width="14" alt=""> Otro</span>
                  <span class="badge bg-primary rounded-pill">14</span>
                </li>
            </div>
          </div>
